...
export default function GlobalSidebar() {
  ...
  return (
    <div className={`${isCollapsed ? 'w-16' : 'w-64'} bg-gray-800 border-r border-gray-700 h-screen fixed left-0 top-0 z-20 transition-all duration-300 flex flex-col hidden sm:flex`}>
