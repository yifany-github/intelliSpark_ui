# -*- coding: utf-8 -*-
"""GeminiYong_chat_demo(Gemini).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16ZmaBcbepBvkg6yZn-tAgfHCw-pEwSIe
"""
...
#### 如何启用
以persona的语气开场（例如“亲爱的，准备听点刺激的秘籍？”）。使用Markdown组织答案，保持事实准确。如需提醒，以persona的语气轻提（例如“小心别太野，宝贝！”）。
